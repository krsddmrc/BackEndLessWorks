...
class ProductAdmin(admin.ModelAdmin):
    ...
    def bring_img_to_list(self, obj):
        if obj.product_img:
            return mark_safe(f"<img src={obj.product_img.url} width=50 height=50></img>") #! mark_safe import edilmeli.
        return mark_safe("******") #!Mark_safe django return tag'leri kabul etmiyor, hata veriyor. hata vermemesi için mark_safe içine alıyoruz.
...
admin.site.site_title = "Clarusway Title" #! tabdaki ismi değiştirdi.
