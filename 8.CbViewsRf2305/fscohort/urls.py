...
urlpatterns = [
    #path('', home, name="home"),
    #path('', HomeView.as_view(), name="home"), #!1. yöntem
    path('', TemplateView.as_view(template_name="fscohort/home.html"), name="home"),#! classview
''' Eğer context konmayacaksa en kolayı 3. yöntem. buna da context konabilir, nasıl konacağı dökümantsyonda'''
    #path('student_list/', student_list, name="list"),
    path('student_list/', StudentListView.as_view() , name="list"),#! classview
