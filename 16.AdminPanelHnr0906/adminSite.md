...
admin.site.site_title = "Clarusway Title"#----tab'daki (safya başlğı , normal title) isim 
admin.site.site_header = "Clarusway Admin Portal" # -----normal header
admin.site.index_title = "Welcome to Clarusway Admin Portal"#----alt başlık
```

Add data with Faker package
* pip install Faker #test paketi
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ("name", "create_date", "is_in_stock", "update_date") # bunu admin'e attım
